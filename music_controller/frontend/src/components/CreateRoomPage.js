...
export default class CreateRoomPage extends Component {
    ...
    constructor(props) {
        ...
        this.handleUpdateRoomButtonClick = this.handleUpdateRoomButtonClick.bind(this);
          ...
          >
            ...
            <Grid item xs={12} align="center">
                <FormControl component='fieldset'>
                    ...
                    <RadioGroup row defaulValue={this.props.guestCanPause.toString()} onChange={this.handleGuestCanPause}>
